...
const (
	WeatherService_QueryWeather_FullMethodName = "/weather.WeatherService/QueryWeather"
...
func (c *weatherServiceClient) QueryWeather(ctx context.Context, in *WeatherRequest, opts ...grpc.CallOption) (WeatherService_QueryWeatherClient, error) {
	stream, err := c.cc.NewStream(ctx, &WeatherService_ServiceDesc.Streams[0], WeatherService_QueryWeather_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
